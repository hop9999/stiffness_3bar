...
r  = sym('r', [3, 1]); assume(r, 'real');
ro = sym('ro',[4, 1]); assume(ro, 'real');
k  = robot.k;
...
S1 = getStiffness(r(:, 1), get_node(robot, 5), k(5), ro(1));
S2 = getStiffness(r(:, 1), get_node(robot, 4), k(6), ro(2));
S3 = getStiffness(r(:, 1), get_node(robot, 3), k(3), ro(3));
S4 = getStiffness(r(:, 1), get_node(robot, 1), k(11), ro(4));
